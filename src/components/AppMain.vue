  ...
  export default {
    ...
    methods:{
      getImagePath: function(img){
        return new URL(`../assets/img/buy-comics${img}.png`, import.meta.url).href
      }
    }
...
<template>
  <div class="main-top">
    ...
    <div class="row">
      <div class="col" v-for="card in cards">
        <AppCard :image="card.thumb" :title="card.series" />
      </div>
    </div>
    </div>
  </div>
  <div class="main-bottom">
    <div class="container">
      <ul>
        <li v-for=" item in navMain">
          <a href="">
            <!-- <img src="../assets/img/buy-comics-shop-locator.png" alt=""> -->
            <img :src="getImagePath(item.icona)" alt="">
...
.main-bottom{
  ...
  .container{
    height: $height130;
    line-height: $height130;
    ul{
      color:white;
      @include display-flex(space-around,center,2rem);
      img{
      width: 2rem;
